...
const SinglePost = lazy(() =>
  import("./Main/SingleUser/Components/SinglePost/SinglePost")
);
...
const GlobalZoneSinglePost = lazy(() =>
  import(
    "./Main/GlobalZone/Components/GlobalZoneSinglePost/GlobalZoneSinglePost"
  )
);
  ...
  if (token) {
    routes = (
      <Switch>
        ...
        <Route
          path="/globalzone/post/:postId"
          component={GlobalZoneSinglePost}
          exact
        />
